...
// Paleta Principal (Mantida para consistência)
...
// Paleta Clara (Mantida para quem prefere)
val LightThemeBackground = Color(0xFFFFFFFF)
val LightThemeSurface = Color(0xFFF5F5F5)
val LightThemeTextPrimary = Color(0xFF212121)